...
// ข้อความแรกสุดของ batch รอ 10 วิ (ให้เวลาลูกค้าพิมพ์ประโยคต่อได้ทัน) ส่วนข้อความถัดๆ ไปในรอบเดียวกันรอแค่ 5 วิพอ (ลูกค้าน่าจะพิมพ์ใกล้จะจบแล้ว)
const FIRST_BATCH_WAIT_MS = 10 * 1000;
const SUBSEQUENT_BATCH_WAIT_MS = 5 * 1000;
